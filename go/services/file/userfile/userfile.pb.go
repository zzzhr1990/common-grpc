...
type FileHistoryEx struct {
	...
	Size                 int64    `protobuf:"varint,2,opt,name=size,proto3" json:"size,omitempty"`
	Ctime                int64    `protobuf:"varint,3,opt,name=ctime,proto3" json:"ctime,omitempty"`
	DownloadAddress      string   `protobuf:"bytes,4,opt,name=downloadAddress,proto3" json:"downloadAddress,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_8869c2ca76fd1758 = []byte{
	...
	,
}
