...
func (x *BatchTaskResult) Reset() {
	*x = BatchTaskResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_common_entity_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchTaskResult) Descriptor() ([]byte, []int) {
	return file_common_common_entity_proto_rawDescGZIP(), []int{12}
}
...
var file_common_common_entity_proto_rawDesc = []byte{
	...
	0x57, 0x0a, 0x0f, 0x42, 0x61, 0x74, 0x63, 0x68, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x01,
	...
	0x08, 0x52, 0x05, 0x61, 0x73, 0x79, 0x6e, 0x63, 0x42, 0x2c, 0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68,
...
var file_common_common_entity_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_common_common_entity_proto_goTypes = []interface{}{
	...
	(*BatchTaskResult)(nil),  // 12: services.BatchTaskResult
}
...
func file_common_common_entity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_common_entity_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchTaskResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
